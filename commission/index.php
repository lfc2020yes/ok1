...
<?
 ...
 <div class="section" id="section1">
  ...
  <div class="liderbord_2021">
        ...
        $result_te = mysql_time_query($link, 'select *,c.name,b.id_promo from affiliates_history_trips as a,trips as b,trips_country as c where a.id_trips=b.id and b.id_country=c.id and a.id_users="' . ht($id_user) . '" order by a.datetimes desc');
