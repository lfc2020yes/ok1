...
if($result_88) {
    ...
    while ($row_88 = mysqli_fetch_assoc($result_88)) {
        ...
        if ((($row_8["id_shopper"] != $id) and ($row_8["shopper"] == 1))or($row_8["shopper"] == 2)) {
            $pokup = '<span class="uc2">УЧАСТНИК</span>';
        }
...
{
	$query_string.='<div class="message_search_b message_clients_cb"><span>Информация о путешествиях туриста неизвестна</span></div>';
}
