...
if(!token_access_new($token,'dell_operator_xx',$id,"s_form"))
{
...
//**************************************************
$result_t=mysql_time_query($link,'Select b.id from booking_operator as b where b.id="'.htmlspecialchars(trim($_GET['id'])).'"');
...
mysql_time_query($link,'delete FROM booking_operator where id="'.htmlspecialchars(trim($_GET['id'])).'"');
