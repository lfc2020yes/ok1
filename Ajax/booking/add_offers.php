...
$status_ee='ok';
 ...
 mysql_time_query($link,'INSERT INTO booking_offers (id_users,id_booking,datetime,visible) VALUES ("'.$id_user.'","'.$id.'","'.$date_.'","1")');
$ID_N=mysqli_insert_id($link); 
mysql_time_query($link,'update booking set ready="0" where id = "'.htmlspecialchars($id).'"');
