...
if(!token_access_new($token,'dell_offers_xx',$id,"s_form"))
{
...
//**************************************************
$result_t=mysql_time_query($link,'Select b.id_user,b.status,b.id_object,a.id,a.cost,a.id_booking from booking_offers as a,booking as b where a.id_booking=b.id and a.id="'.htmlspecialchars(trim($_GET['id'])).'"');
...
mysql_time_query($link,'update booking set ready="0" where id = "'.htmlspecialchars($row_t["id_booking"]).'"');
