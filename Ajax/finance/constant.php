...
//**************************************************
$result_t=mysql_time_query($link,'Select b.* from finance_operation as b where b.id="'.htmlspecialchars(trim($_GET['id'])).'" and b.visible=1 and b.id_a_company="'.ht($id_company).'"');
