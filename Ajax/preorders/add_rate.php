...
mysql_time_query($link,'INSERT INTO preorders_status_history_new (id_preorder,action_history,id_user,datetimes,edit,comment,comment_sys) VALUES ("'.ht($_POST['id']).'","1","'.ht($id_user).'","'.date("y.m.d").' '.date("H:i:s").'","1","'.ht($_POST['rate']).'","")');
