...
mysql_time_query($link,'INSERT INTO trips_status_history_new (id_trips,action_history,id_user,datetimes,edit,comment,comment_sys) VALUES ("'.ht($_GET['id']).'","15","'.ht($id_user).'","'.date("y.m.d").' '.date("H:i:s").'","1","'.ht($_GET['text']).'","")');
