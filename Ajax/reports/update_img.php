...
//**************************************************
$result_t=mysql_time_query($link,'Select a.* from reports as a where a.id="'.$id.'"');
...
$result_score=mysql_time_query($link,'Select a.* from reports_attach as a where a.id_reports="'.$id.'"');
