...
//**************************************************
$result_t=mysql_time_query($link,'Select a.*,b.id_user from reports_attach as a,reports as b where a.id_reports=b.id and a.id="'.$id.'"');
...
mysql_time_query($link,'delete FROM reports_attach where id="'.htmlspecialchars(trim($_GET['id'])).'"');
