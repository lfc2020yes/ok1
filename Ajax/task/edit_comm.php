...
mysql_time_query($link,'update task_status_history_new set comment="'.ht($_GET['text']).'" where id = "'.ht($_GET['id']).'"');




$result_8 = mysql_time_query($link,'SELECT A.* FROM task_status_history_new AS A WHERE A.id="'.ht($_GET['id']).'"');
