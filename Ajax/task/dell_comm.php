...
$result_t=mysql_time_query($link,'Select b.* from task_status_history_new as b where b.id="'.htmlspecialchars(trim($_GET['sel'])).'" and b.edit=1');
...
$status_ee='ok';
 ...
 mysql_time_query($link,'delete FROM task_status_history_new where id="'.ht($_GET['sel']).'"');  
