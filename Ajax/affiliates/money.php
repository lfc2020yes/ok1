...
$result_uu = mysql_time_query($link, 'select a.all_comission,a.paid_comission,b.name_user,a.block_comission from affiliates as a,r_user as b where b.id=a.id_users and a.id_users="'.ht($_POST["id"]).'" ');
