...
if(!token_access_new($token,'dell_clients_xx',$id,"s_form"))
{
...
//**************************************************
$result_t=mysql_time_query($link,'Select b.id_user,b.id from k_clients as b where b.id="'.htmlspecialchars(trim($_GET['id'])).'"');
...
mysql_time_query($link,'update k_clients set visible="0" where id = "'.htmlspecialchars($row_t["id"]).'"');
