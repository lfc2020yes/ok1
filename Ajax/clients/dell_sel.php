...
$result_t=mysql_time_query($link,'Select b.id_user from selection as b where b.id="'.htmlspecialchars(trim($_GET['sel'])).'" and b.visible=1');
...
AddHistoryTask('6',$id_user,$row_bila["id"],'','','','','','','',$link,'Удалена так как удалили подборку к которому она была привязана');
