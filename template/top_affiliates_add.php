...
<div class="menu-09  input-line" style="z-index:150;">
    ...
    <div class="menu-09-left">
        ...
        echo'<span class="menu-09-pc-h" ><span >  Добавление нового партнера </span ></span >';
    ...
    <div class="menu-09-right tours-right-block">
        ...
        if ($role->permission('Партнеры','A'))
        {
            ...
            echo'<div class="menu-09-inline"><div data-tooltip="добавить партнера" class="menu-09-button yellow-09 js-add-affiliates" style="margin-left: 0px; width: auto;"><span class="label--b">Добавить</span></div></div>';
        }
