...
<div class="menu-09  input-line" style="z-index:150;">
    ...
    <div class="menu-09-left">
        ...
        echo'<span class="menu-09-pc-h" ><span > Cотрудник - '.$row_list["name_user"].' </span ></span >';
...
/*
	...
	alert_message(\'error\',\'Ошибка! Не все поля заполнены\');
        ...
        echo'<div class="menu-09-inline"><div data-tooltip="сохранить изменения" class="menu-09-button yellow-09 js-save-users" style="margin-left: 0px; width: auto;"><span class="label--b">сохранить</span></div></div>';
        }
