...
$nav_text=array("Задачи","Финансы","Обращения","Туры","Клиенты","Туроператоры","Сотрудники","Отчеты","Бухгалтерия","Договора","Статистика","Настройки");
$nav_url=array("task","finance","preorders","tours","clients","touroperator","users","reports","accounting","contracts","statistic_new","settings");
$nav_plus=array("1","0","1","2","1","0","0","0","0","0","0","0");
$nav_url_a=array("","","","tours/add/","","","","","","","","");
