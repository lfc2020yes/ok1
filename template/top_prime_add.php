    ...
    <?
    echo'<h3 class="head_h" style=" margin-bottom:0px; float:left;"> Наряд №'.$_GET['add'].' <span class="edit_12" style="visibility:visible"><span class="icc">y</span> <strong>Добавление работ</strong></span><div></div></h3>';
...
<div data-tooltip="Добавить раздел" class="add_seb"></div>
   -->
    ...
    <?
    	   echo'<a href="finery/plus/'.$_GET['add'].'/" style="float:right;" class="save_button add_nar"><i>Сохранить</i></a>';
