...
$active_menu='contracts';  // в каком меню
...
if($error_header!=404){ SEO('contracts','','','',$link); } else { SEO('0','','','',$link); }
...
echo'<div class="content" iu="'.$id_user.'">';
	  ...
	  include_once $url_system.'template/top_contracts.php';
 ...
 <div class="section" id="section1">
	...
	<div class="oka_block_2019" style="min-height:auto !important;">
        ...
        <div class="line_mobile_blue">Договора с клиентами</div>
...
$class_js_readonly='';
	...
	if(($sign_level==2)or($sign_level==3)or($sign_level==4))
		...
		if (( isset($_COOKIE["su_5cc".$id_user]))and(array_search($_COOKIE["su_5cc".$id_user],$os_id5)!==false))
		{
		   ...
		   echo'<div class="left_drop menu1_prime book_menu_sel js--sort gop_io '.$class_js_search.'" style="z-index:'.$zindex.'"><label>Оформлен</label><div class="select eddd"><a class="slct" list_number="t6" data_src="'.$os_id5[array_search($_COOKIE["su_5cc".$id_user], $os_id5)].'">'.$os5[array_search($_COOKIE["su_5cc".$id_user], $os_id5)].'</a><ul class="drop">';
