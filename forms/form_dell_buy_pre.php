...
$status_admin=0;
$result_t=mysql_time_query($link,'Select b.* from preorders as b where b.id="'.htmlspecialchars(trim($_GET['id_buy'])).'" and b.visible=1 and b.id_company IN ('.ht($id_company).')');
