...
$token=token_access_compile($_GET['id'],'no_bookings_xx',$secret);
//составление секретного ключа формы
//составление секретного ключа формы
//составление секретного ключа формы
...
<div class="top_modal">
  ...
  <? echo'<h1 class="h111" mor="'.$token.'" for="'.htmlspecialchars(trim($_GET['id'])).'"><span>Отказались от заявки</span></h1>'; ?>
...
echo'<div class="comme">Очень жаль, что вы не смогли склонить клиента на вашу сторону и предложить ему оптимальное предложение.</div>';
...
?>	
       ...
       <div class="div_textarea_otziv1" >
			<div class="otziv_add">
                   ...
                   <?
        echo'<textarea cols="10" rows="1" placeholder="Ваш комментарий" id="otziv_area_adaxx2" name="comment_b" class="di text_area_otziv no_comment_bill22"></textarea>';
				?>
            </div>      
</div>  
...
<div id="button_no_offers" class="save_button"><i>Отказались</i></div>
