...
$token=token_access_compile($_GET['id'],'dell_answer_xx',$secret);
//составление секретного ключа формы
//составление секретного ключа формы
//составление секретного ключа формы
...
<div class="top_modal">
  ...
  <? echo'<h1 class="h111" mor="'.$token.'" for="'.htmlspecialchars(trim($_GET['id'])).'"><span>Удаление вопроса</span></h1>'; ?>
...
echo'<div class="comme">Вы точно хотите удалить вопрос <b>«'.$row_score["text"].'»</b> по отчету <b>№'.$_GET["id"].'</b>?</div>';		
?>	
...
<div id="button_dell_answer" class="save_button"><i>Удалить</i></div>
