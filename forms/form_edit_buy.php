...
$status_admin=0;
$result_t=mysql_time_query($link,'Select A.id,A.id_exchange,A.status_admin from trips as A where A.visible=1 AND A.id="'.ht($_GET["id"]).'" and A.id_a_company="'.$id_company.'"');
