...
$query_string.='<div class="left_drop list_2018 menu1_prime js_proc_no_no"><label class="">Способ оплаты<span>*</span></label><div class="select eddd zin_2019"><a class="slct" list_number="t1" data_src=""></a><ul class="drop js-visible-mt">';
...
if($result_8)
{
    ...
    */
    ...
    while($row_8 = mysqli_fetch_assoc($result_8)){
        ...
        {
            $query_string.='<li><a href="javascript:void(0);" nall="'.$row_8["nall"].'" proc="'.$proc_vip.'" rel="'.$row_8["id"].'">'.$row_8["name"].'</a></li>';
        }
