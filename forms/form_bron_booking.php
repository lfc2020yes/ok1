...
$token=token_access_compile($_GET['id'],'bt_offers_xx',$secret);
//составление секретного ключа формы
//составление секретного ключа формы
//составление секретного ключа формы
...
echo'<div class="comme">Чтобы присвоить данной заявке статус - куплено, необходимо сначала отметить одно предложение,  выбранное клиентом по данной заявке. Для этого нажмите на номер предложения в списке предложений</div>';
...
<div id="button_bron_offers" class="save_button"><i>ОК</i></div>
