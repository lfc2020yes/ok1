<?
$query_string='<div class="form_yes_33">';



$query_string.='<div class="help_div da_book1" style="margin-top: 0px !important;"><span class="h5" style="text-align: center;"><span>Вы подтверждаете что выполнили данную задачу?</span></span></div>';


$query_string.='<div class="div_textarea_say_task" >';
if($row_8["action"]==17)
    {
        $query_string.='<label>Впечатление туриста по данному туру</label>';
	   } else
	       {
	        $query_string.='<label>ваш комментарий по выполнению</label>';
	       }

$query_string.='<div class="otziv_add">';
                 
                   
        $query_string.='<textarea style="height:20px" cols="10" rows="1" placeholder="" id="comment_yes_task" name="comment_b" class="di text_area_otziv no_comment_bill yes_task_new_2020"></textarea>
