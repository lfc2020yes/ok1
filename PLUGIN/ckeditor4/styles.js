...
CKEDITOR.stylesSet.add( 'default', [
    ...
    { name: 'По центру', element: 'p', attributes: { 'class': 'center_p' }},
	{ name: 'По левому краю', element: 'p'},
    { name: 'Цитата', element: 'div', attributes: { 'class': 'blockquote' }},
    { name: 'Подраздел  h3', element: 'h3'},
	{ name: 'Картинка 100%', element: 'img', attributes: { 'class': 'max' }}
