...
//********************************************************************
  ...
  where A.visible=1 '.$sql_svyz_table.' ' . $sql_su2 . ' ' . $sql_su1 . ' ' . $sql_su3 . ' ' . $sql_su4 . ' ' . $sql_su5 . ' ' . $sql_su7 . ' ' . $sql_order . ' ';
...
$titles = array("id", "Название тура","Даты отдыха","Кол-во человек","Клиент","Туроператор","№ заявки","Договор","Оплачено туристом","Оплачено ТО","Менеджер","Организация","Комментарий");
